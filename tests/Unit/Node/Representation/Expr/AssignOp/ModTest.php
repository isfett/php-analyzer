...
use Isfett\PhpAnalyzer\Node\Representation\Expr\AssignOp\Mod;
 ...
 * Class ModTest
 */
class ModTest extends AbstractNodeRepresentationTest
{
    /**
     * @return void
     */
    ...
    {
        $node = new Node\Expr\AssignOp\Mod(
        ...
        $representation = new Mod($this->representation, $node);
